...
[index, center] = kmedoids(Z, cluster_num, 'Distance', label_distance);  % K-medoids clustering
...
for NN1 = 2:cluster_max
    [index, center] = kmedoids(Z, NN1, 'Distance', label_distance);  % K-medoids clustering
