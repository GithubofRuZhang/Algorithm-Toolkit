function [Mdl,fMin,Convergence_curve]  = optimize_canopy(data_O,data_Z,num_pop,num_iter,method_mti)  
...
%   disp([method_mti, '优化dbscn:   ',"  半径范围epsilon:",num2str((pos(1))),"  点个数minpts:",num2str(round(pos(2))),'  distance: ',distance_str{1,round(pos(3))}]) 
 disp([method_mti, '优化canopy:   ',"  阈值范围epsilon:",num2str((pos(1)))]) 
end
function [fitness_value,index]=fit_canopy(pop,data_O,data_Z)
%      distance_str={'precomputed','euclidean','cityblock','cosine','chebychev','minkowski'};
